...
public class LabelAdapter extends ArrayAdapter<LabelRecord> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.labelitem, parent, false);
        }
        ...
        if (lr != null) {
                ...
                if (lr.getLabelName().trim().equals("-") || lr.getLabelName().equals(context.getString(R.string.add_new_label_text))) {
	...
	public View getDropDownView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			LayoutInflater vi = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			v = vi.inflate(R.layout.labelitemlarge, parent, false);
        }
